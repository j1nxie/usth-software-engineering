...
/**
 * @overview A record <code><Doc,cnt></code> where <code>Doc</code> is a
 *           document object
 *           and <code>cnt</code> is an integer count of occurrences of some
 *           keyword in <code>Doc</code>.
 * 
 *           This class also implements a {@link Comparable} interface to
 *           support sorting.
 * 
 * @see "Program development in Java", pgs 329-331,334
 * @note unlike the strict record-type explanation in the text book,
 *       we use setter and getter methods to implement observers and some
 *       mutator methods
 *       of this class
 * 
...
public class DocCnt implements Comparable {
	 ...
	 * @effects If <code>x</code> is <code>null</code> throws
	 *          <code>NullPointerException</code>;
	 *          if <code>x</code> is not an instance of <code>DocCnt</code> throws
	 *          <code>ClassCastException</code>;
	 *          otherwise if <code>this.cnt < x.cnt</code> returns -1, if
	 *          <code>this.cnt = x.cnt</code> returns 0,
	 *          else returns 1.
	 */
	public int compareTo(Object x) throws ClassCastException, NullPointerException {
		if (x == null)
			throw new NullPointerException("DocCnt.compareTo: argument is null");
