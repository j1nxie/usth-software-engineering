...
/**
 * @overview A general helper class responsible for performing procedures that
 *           are
...
public class Helpers {
	 ...
	 * @effects If <code>s</code> is <code>null</code> throws
	 *          <code>NotPossibleException</code>
	 *          else returns a canonical form of <code>s</code>.
	 * @version 2.0 uses the lower-case of <code>s</code> as the canonical form of
	 *          <code>s</code>
	 */
