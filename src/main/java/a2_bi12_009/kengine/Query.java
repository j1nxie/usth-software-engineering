...
public class Query {
	...
	/**
	 * A method to return keywords and matches of <code>this</code> (if any) as
	 * string.
	 * 
	 * @version 4.0
	 */
	...
	/**
	 * A method to return an iterator for the matching documents of the query.
	 *
	 * @effects returns an iterator for the matching documents of the query.
	 * @return an iterator for the matching documents of the query, or null if there
	 *         are no matches.
	 */
