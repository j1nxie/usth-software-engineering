...
public class TitleTable {
	 ...
	 *          throws <code>DuplicateException</code>, else adds <code>d</code>
	 *          with
	 ...
	 * @effects if <code>t</code> is <code>null</code> or there is no document with
	 *          this
	 *          title throws <code>NotPossibleException</code>, else returns the
	 *          document
